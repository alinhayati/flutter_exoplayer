...
public class BackgroundPlayerAnalyticsListener implements AnalyticsListener {
    private static final String TAG = "BackgroundAnalytics";

    private AnalyticsCallback callback;

    public BackgroundPlayerAnalyticsListener(AnalyticsCallback callback) {
    ...
    public interface AnalyticsCallback{
        void doOnLoadError(EventTime eventTime,
                           MediaSourceEventListener.LoadEventInfo loadEventInfo);
